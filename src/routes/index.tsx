  ...
  return (
    ...
    >
      <svg viewBox="0 0 32 32" className="h-7 w-7" fill="#ffffff" aria-hidden="true">
        <path d="M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.1c-.802-.402-1.504-.817-2.163-1.447-.545-.516-1.146-1.29-1.46-1.963a.426.426 0 0 1-.073-.215c0-.33.99-.945.99-1.49 0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187 0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032 1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23 1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817 0 2.15-.515 2.478-1.318.13-.315.13-.63.13-.977 0-.14-.028-.187-.115-.245-.216-.128-1.836-.888-2.15-1.075zM16.15 26.585c-1.674 0-3.32-.457-4.75-1.318l-3.32.888.888-3.234a9.148 9.148 0 0 1-1.404-4.87c0-5.055 4.13-9.184 9.184-9.184 5.055 0 9.185 4.13 9.185 9.184 0 5.055-4.13 9.184-9.184 9.184zm.026-20.16a10.98 10.98 0 0 0-10.99 10.99c0 1.87.472 3.71 1.375 5.328L4.71 27.98l5.4-1.404a11.02 11.02 0 0 0 5.276 1.404c6.078 0 10.99-4.912 10.99-10.99 0-6.077-4.912-10.99-10.99-10.99z"/>
      </svg>
    </a>
  );
}
